...
const ScrollStack = ({
  ...
  useLayoutEffect(() => {
    ...
    // Find cards either globally (for window scroll) or within the scroller
  ...
  const containerClassName = useWindowScroll
    ? `scroll-stack-container-window ${className}`.trim()
    : `scroll-stack-container-local ${className}`.trim();
