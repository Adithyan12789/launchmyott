...
const Shuffle = ({
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          wrap.style.cssText = 'display:inline-block;overflow:hidden;text-align:left;vertical-align:bottom;';
          wrap.style.width = w + 'px';
          if (shuffleDirection === 'up' || shuffleDirection === 'down') wrap.style.height = h + 'px';

          const inner = document.createElement('span');
          inner.style.cssText = 'display:inline-block;will-change:transform;transform-origin:left center;';
          ...
          firstOrig.style.cssText = `display:inline-block;text-align:left;width:${w}px;font-family:${computedFont};`;

          ch.setAttribute('data-orig', '1');
          ch.style.cssText = `display:inline-block;text-align:left;width:${w}px;font-family:${computedFont};`;

          inner.appendChild(firstOrig);
          for (let k = 0; k < rolls; k++) {
            const c = ch.cloneNode(true);
            if (scrambleCharset) c.textContent = rand(scrambleCharset);
            c.style.cssText = `display:inline-block;text-align:left;width:${w}px;font-family:${computedFont};`;
            inner.appendChild(c);
          }
    ...
    },
    {
      dependencies: [
        ...
        respectReducedMotion, triggerOnHover, onShuffleComplete, userHasFont
      ],
      scope: ref
    }
  );
  ...
  return React.createElement(Tag, { ref, className, style: commonStyle }, text);
};
